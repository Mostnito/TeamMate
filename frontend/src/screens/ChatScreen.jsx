  ...
  return (
    <div style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
      <div style={{ padding: '16px 24px', borderBottom: '1px solid #E5E7EB', display: 'flex', alignItems: 'center', gap: 10, background: '#fff' }}>
        <span style={{ cursor: 'pointer', color: '#374151' }} onClick={v.goTeamDetail}>←</span>
        <div>
      ...
      <div style={{ padding: '14px 24px', borderTop: '1px solid #E5E7EB', display: 'flex', alignItems: 'center', gap: 10, background: '#fff' }}>
        ...
        <button onClick={v.sendChat} style={{ width: 36, height: 36, borderRadius: '50%', background: '#2563EB', color: '#fff', border: 'none', cursor: 'pointer', fontSize: 14 }}>➤</button>
      </div>
    </div>
  );
}
